...
public class Test {
	public static void main(String[] args) {
		String sparkDir = "/Users/michaelkunkel/Spark/spark-2.2.1-bin-hadoop2.7/";
		SparkSession spark = SparkManager.getSession();

		// $example on$
		// Load and parse the data file, converting it to a DataFrame.
		Dataset<Row> data = spark.read().format("libsvm").load(sparkDir + "data/mllib/sample_libsvm_data.txt");
